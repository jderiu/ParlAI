...
python parlai/scripts/self_chat.py -m bert_ranker/bi_encoder_ranker  -t empathetic_dialogues:selfchat -mf tmp/empathetic_dialogues/bert_rank/model_bert_rank_final --fixed_candidates_path tmp/empathetic_dialogues/cands.txt