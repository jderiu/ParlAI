...
do
  ...
  python -m parlai.scripts.self_chat -t $dataset:selfchat -m seq2seq -mf tmp/"$dataset"/seq2seq/model_s2s_2_512_gru_bi_final --inference nucleus --outfile tmp/dailydialog/model_s2s_2_512_gru_bi_final.json
done